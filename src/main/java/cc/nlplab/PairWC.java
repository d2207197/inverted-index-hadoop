...
public class PairWC<F extends WritableComparable, S extends WritableComparable>  implements WritableComparable {
    @NonNull private Class<? extends WritableComparable> firstClass;
    @NonNull private Class<? extends WritableComparable> secondClass;
    @NonNull private F first;
    @NonNull private S second;
